...
- **Agent / LLM optimisation:** JSON-LD `Person` and `WebSite` schemas (`includes/head.html`), `rel=me` links to GitHub/LinkedIn/HF/ORCID, plain-text `llms.txt` summary at the site root.
